...
# -----------------------------
# Instalación de Hyprland y software necesario
# -----------------------------
echo "Instalando Hyprland..."
yay -S --noconfirm hyprland-git waybar rofi alacritty feh lxappearance htop zathura zathura-pdf-poppler neovim
