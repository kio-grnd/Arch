...
# -----------------------------
# Instalación de i3 y software necesario
# -----------------------------
pacman -S --noconfirm --needed i3 i3status i3lock dmenu alacritty rofi polybar bat ranger ueberzug wget curl zsh zsh-completions rxvt-unicode feh htop lxappearance zathura zathura-pdf-poppler neovim alsa-utils ttf-bitstream-vera
